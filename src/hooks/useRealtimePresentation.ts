...
const DEFAULT_SLIDES: SlideContent[] = [
    ...
    projects: [
      {
        ...
        description: 'Your AI assistant that lives on your machine. OpenClaw connects to WhatsApp, Telegram, Discord and more — giving you a personal AI that can control your computer, manage files, browse the web, and integrate with any tool.',
        features: ['Multi-channel messaging (WhatsApp, Telegram, Discord)', 'Full system access & automation', 'Extensible skills & tool ecosystem'],
      },
    ],
  },
  ...
  // DB90 LEAD-IN - Legacy Tech EOL
  {
    ...
    legacyCards: [
      { name: 'COBOL', logo: '/cobol-logo.svg', description: '220 billion lines still in production', meta: 'Since 1959 • Avg dev age: 55+' },
      { name: 'AS/400', logo: '/ibm-logo.png', description: 'IBM i RPG applications', meta: 'Since 1988 • Banks & insurance' },
      { name: 'FoxPro', logo: '/microsoft-logo.png', description: 'Microsoft ended support', meta: 'EOL: January 2015' },
      { name: 'VB6', logo: '/vb-logo.png', description: 'Visual Basic 6 extended support ended', meta: 'EOL: April 2008' },
      { name: 'FilePro', logo: '/filepro-logo.svg', description: 'DOS-era database applications', meta: 'Obsolete since 1990s' },
      { name: 'PowerBuilder', logo: '/sap-logo.png', description: 'Enterprise client-server apps', meta: 'Declining talent pool' },
    ],
  },
  {
    id: 19,
